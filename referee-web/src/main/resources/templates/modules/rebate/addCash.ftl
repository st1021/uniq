	...
	<div class="page-container-custom">
		...
		<div class="portlet light ">
				<ul class="nav nav-tabs mb-25">
		            <li >
		                <a  href="${ctx}/rebate/cashLog">Cash Withdrawal Record </a>
		            </li>
		            <li class="active">
		                <a  href="javascript:;">
		                	Cash-out Request
	            ...
	            <div class="portlet-body form">
					...
					<@form.form id="inputForm" modelAttribute="obj" action="${ctx}/rebate/saveCash" method="post" class="form-horizontal" >
						<div class="form-body">
							...
							<div class="form-group">
									<label class="col-md-3 control-label">Withdrawal Amount:</label>
									<div class="col-md-4">
										<input name="cashAmount" id="cashAmount" type="text" value=""  maxlength="11" class="form-control required digits" />
									</div>
							</div>
							<div class="form-group">
									<label class="col-md-3 control-label">Bank Account Holder Name:</label>
									<div class="col-md-4">
