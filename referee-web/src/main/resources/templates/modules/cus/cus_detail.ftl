				...
				<@tags.message content=message! />
				 <div class="form-body">
				 	...
				 	<div class="form-group">
						<label class="col-md-3 control-label">User's Profile Picture:</label>
						<div class="col-md-4">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">User's information:</label>
						<div class="col-md-4">
					...
					<#if is_open_vip?? && is_open_vip>
						<div class="form-group">
							<label class="col-md-3 control-label">VIP Membership:</label>
							<div class="col-md-4">
								<p class="form-control-static">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">Registration time:</label>
						<div class="col-md-4">
							<p class="form-control-static">
					...
					<#if u_regist?? && u_regist >
						<div class="form-group">
							<label class="col-md-3 control-label">Verification Status:</label>
							<div class="col-md-4">
								<p class="form-control-static">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Verification Steps:</label>
							<div class="col-md-4">
								<p class="form-control-static">
