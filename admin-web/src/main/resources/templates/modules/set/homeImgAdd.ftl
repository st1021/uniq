					...
					<div class="form-group">
						...
						<div class="col-md-4">
							  <div class="upload-pic-box">
		                        ...
		                        <button type="button" id="initImgButton" class="btn btn-mini btn-default">上传图片</button>
		                        <div class="form-tips">建议尺寸：600*700像素</div>
		                        <div id="initImgBox" class="view-pic-list">
		                        	<#if info.initImg ?? && info.initImg?length gt 0>
		                        		<span class="item"><img src="${info.initImg!}"><i class="remove js-remove-upload">×</i></span>
		                        	</#if>
		                        </div>
		                    </div>
						</div>
