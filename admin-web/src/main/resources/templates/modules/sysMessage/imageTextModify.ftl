	...
	<div class="page-container-custom">
		...
		<div class="portlet light ">
				<ul class="nav nav-tabs mb-25">
		            <li >
		                <a  href="${ctx}/sys/imageText/list?imageType=1">
List
		                </a>
		            </li>
		            <li class="active">
				...
				<@form.form id="inputForm" modelAttribute="info" action="${ctx}/sys/imageText/save_image" method="post" class="form-horizontal">
					<@form.hidden path="id"/>
