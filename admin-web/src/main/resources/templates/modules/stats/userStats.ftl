    ...
    <div class="page-container-custom">
		<div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span><@spring.message code="stats.userStatistics"></@spring.message></span>
                </li>
            </ul>
        </div>
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-green bold"><@spring.message code="stats.userStatistics"></@spring.message></span>
                </div>
            </div>
             <@form.form id="searchForm" modelAttribute="vo" action="${ctx}/sys/stats/userStats" method="post" class="breadcrumb form-search">
            <div>
            	&nbsp;&nbsp;&nbsp;
        ...
        require(
            ...
            function (ec, theme) {
                ...
                userNumsLine.setOption(
                	{
                		title : {
					        text: '${vo.time!} <#if vo.statsType=='1'><@spring.message code="stats.year"></@spring.message></#if><#if vo.statsType=='2'><@spring.message code="stats.month"></@spring.message></#if> <@spring.message code="sys.userGrowthTrendCharts"></@spring.message>',
					        x:'left'
					    },
					    tooltip : {
					        trigger: 'axis'
					     ...
					     legend: {
					        data:['<@spring.message code="sys.userNumber"></@spring.message>']
					    },
					    toolbox: {
					        show : true,
					        feature : {
					    ...
					    series : [
					        {
					            name:'<@spring.message code="sys.userNumber"></@spring.message>',
					            type:'line',
					            data:
									${numStr!}
