...
<head>
	<script type="text/javascript">
	    ...
	    {
	    	// 正常打开
			top.$.jBox.open("iframe:${ctx}/sys/userMoneyCash/checkForm?id="+id, "Introducer Withdrawal", 500, 250, {
	            ...
	            if (v === 'ok') {
	            	  ...
	            	  $.ajax({
			                 	...
			                 	success:function(data){
			                 		...
			                 		window.location.href="${ctx}/sys/userMoneyCash/refereeCash";
			                 	}
			          	 });
	            }
	            return true;
	...
	<div class="page-container-custom">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span><@spring.message code="financial.withdrawal.introducer" /></span>
                </li>
            </ul>
        </div>
        ...
        <@form.form id="searchForm" action="${ctx}/sys/userMoneyCash/refereeCash" method="post" class="breadcrumb form-search">
        	<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo!}"/>
			<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize!}"/>
			<@spring.message code="userInfo.introducer.name" />：<input type="text" name="refereeName" value="${vo.refereeName!}" maxlength="50" class="form-control input-small input-inline"/>
			&nbsp;&nbsp;
			<@spring.message code="sys.mobile"></@spring.message>：<input type="text" name="contactMobile" value="${vo.contactMobile!}" maxlength="50" class="form-control input-small input-inline"/>
			&nbsp;&nbsp;
          ...
          <div class="portlet-body">
            ...
            <#if page.list?size &gt; 0 >
                <div class="table-scrollable">
					...
					<tr>
						<th width="8%"><@spring.message code="userInfo.introducer.name" /></th>
					...
					<tr>
					<td>${info.refereeName!''} <br/> ${info.contactMobile!''}</td>
