...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$.get("${ctx}${url}${(url?index_of('?')==-1)?string('?','&')}&extId=${extId}&module=${module!}&t="+new Date().getTime(), function(zNodes){
				// 初始化树结构
...
<body>
	...
	<div id="<@spring.message code='form.query'></@spring.message>" class="control-group hide" style="padding:10px 0 0 15px;">
