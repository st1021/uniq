...
public class OfficeController extends BaseController {
	...
	@SecurityMapping(name="role.list",permGroup="role.office",userType=SysUserContant.USER_TYPE_1)
	...
	@RequiresPermissions("sys:office:modify")
	@SecurityMapping(name="role.edit",permGroup="role.office",userType=SysUserContant.USER_TYPE_1)
	@RequestMapping("form")
	...
	@SecurityMapping(name="role.delete",permGroup="role.office",userType=SysUserContant.USER_TYPE_1)
