                    ...
                    <#--会员 -->
	                    <li>
	                        <a href="javascript:;">
		                        ...
		                        <span class="title">&nbsp;<@spring.message code="agent.index.memberTitle"></@spring.message></span>
		                        <span class="arrow "></span>
	                        </a>
	                        <ul class="sub-menu">
	                            <li>
	                                <a target="mainFrame" href="${ctx}/customer/list">
	                                &nbsp;<@spring.message code="agent.index.memberList"></@spring.message>
	                                </a>
	                            </li>
	                        </ul>
	                    </li>
					...
					<li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                ...
                                &nbsp;<@spring.message code="agent.index.incomeList"></@spring.message>
                                </a>
                            </li>
                            <li>
                                <a target="mainFrame" href="${ctx}/rebate/cashLog">
                                &nbsp;<@spring.message code="agent.index.incomeLogs"></@spring.message>
                                </a>
                            </li>
                            <li>
