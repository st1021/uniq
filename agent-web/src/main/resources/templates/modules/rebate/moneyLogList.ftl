	...
	<div class="page-container-custom">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
				    <span><@spring.message code="agent.balance.list"></@spring.message></span>
				</li>
            </ul>
        </div>
        ...
        <div class="portlet light portlet-fit portlet-datatable ">
	       <ul class="nav nav-tabs mb-25">
	            <li class="active">
	                <a data-toggle="tab" href="javascript:;"><@spring.message code="agent.balance.list"></@spring.message></a>
	            </li>
	        </ul>
        	...
        	<@form.form id="searchForm" modelAttribute="vo" action="${ctx}/rebate/moneyLog" method="post" class="breadcrumb form-search">
					...
					<@spring.message code="agent.balance.statsTime"></@spring.message>：<input type="text" readonly="readonly" name="startTime" value="${(vo.startTime)!}" class="form-control input-small input-inline" onclick="WdatePicker()"/> -
					...
					&nbsp;&nbsp;
					<label><@spring.message code="agent.balance.logType"></@spring.message>：</label>
         ...
         <#if (page.content?size > 0)>
	        <div class="portlet-body">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-checkable order-column dataTable">
					<tr>
						<th><@spring.message code="agent.balance.logType"></@spring.message></th>
						<th><@spring.message code="agent.balance.srcAmount"></@spring.message></th>
			            <th><@spring.message code="agent.balance.exchangeRate"></@spring.message></th>
			            <th><@spring.message code="agent.balance.aimAmount"></@spring.message></th>
			            <th><@spring.message code="agent.balance.statsTime"></@spring.message></th>
					</tr>
