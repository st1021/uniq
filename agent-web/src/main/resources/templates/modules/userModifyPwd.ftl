	...
	<div class="page-container-custom">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span><@spring.message code="agent.index.modifyPwd"></@spring.message></span>
                </li>
            </ul>
        </div>
		...
		<div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-green bold"><@spring.message code="agent.index.modifyPwd"></@spring.message></span>
                </div>
            </div>
                ...
                <@form.form id="inputForm" modelAttribute="user" action="${ctx}/modifyPwd" method="post" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
							<label class="col-md-3 control-label"><span class="c-red">*</span><@spring.message code="agent.info.oldPWD"></@spring.message>: </label>
							<div class="col-md-4">
								<input id="oldPassword" name="oldPassword" type="password" value="" maxlength="50" minlength="3" class="form-control required"/>
							</div>
						</div>
                        <div class="form-group">
							<label class="col-md-3 control-label" for="newPassword"><span class="c-red">*</span><@spring.message code="agent.info.newPWD"></@spring.message>: </label>
							<div class="col-md-4">
								<input id="newPassword" name="newPassword" type="password" value="" maxlength="50" minlength="3" class="form-control required"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="confirmNewPassword"><span class="c-red">*</span><@spring.message code="agent.info.confirmPassword"></@spring.message>: </label>
							<div class="col-md-4">
