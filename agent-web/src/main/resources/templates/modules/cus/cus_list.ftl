	             				...
	             				type:"POST",
	             					success:function(data){
	                 					if(1 == data) {
	                 						...
	                 						top.$.jBox.tip('<@spring.message code="agent.form.failure"></@spring.message>');
	                 					}
	             					}
	             				});
	        				}
	...
	<div class="page-container-custom">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
				    <span><@spring.message code="agent.member.info"></@spring.message></span>
				</li>
            </ul>
        </div>
        ...
        <div class="portlet light portlet-fit portlet-datatable ">
	       <ul class="nav nav-tabs mb-25">
	            <li class="active">
 					<a data-toggle="tab" href="javascript:;"><@spring.message code="agent.form.list"></@spring.message></a>
	            </li>
	        </ul>
        	...
        	<@form.form id="searchForm" modelAttribute="vo" action="${ctx}/customer/list" method="post" class="breadcrumb form-search">
					...
					<div>
						<label><@spring.message code="agent.member.nickname"></@spring.message>：</label><@form.input path="nickname" htmlEscape=false maxlength="50" class="form-control input-small input-inline"/>
						&nbsp;&nbsp;
						<label><@spring.message code="agent.member.phone"></@spring.message>：</label><@form.input path="mobile" htmlEscape=false maxlength="50" class="form-control input-small input-inline"/>
						&nbsp;&nbsp;
						<label><@spring.message code="agent.member.status"></@spring.message>：
						...
						&nbsp;&nbsp;
						<label><@spring.message code="agent.member.country"></@spring.message>：
						...
						<label><@spring.message code="agent.cabinet.id"></@spring.message>：</label><@form.input path="sysCode" htmlEscape=false maxlength="50" class="form-control input-small input-inline"/>
						<#if openCard?? && openCard>
							&nbsp;&nbsp;
							<label><@spring.message code="agent.member.memberCard"></@spring.message>：
							...
							&nbsp;&nbsp;
							<label><@spring.message code="agent.member.vip"></@spring.message>：
	        ...
	        <div class="portlet-body">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-checkable order-column dataTable">
					<tr>
			            ...
			            <th width="4%"><@spring.message code="agent.member.nickname"></@spring.message></th>
			            <th width="4%"><@spring.message code="agent.member.country"></@spring.message></th>
			            <#if adminRegist ?? && adminRegist>
			            	<th width="5%"><@spring.message code="agent.member.number"></@spring.message></th>
			            </#if>
			            
			            <#if openCard?? && openCard>
				            <th width="10%"><@spring.message code="agent.member.vip"></@spring.message></th>
			            </#if>
			            
			            <#if isOpenBalance?? && isOpenBalance>
			            	<th width="5%"><@spring.message code="agent.member.balance"></@spring.message></th>
			            </#if>
			            ...
			            <#if sysSet.isNeedAuthenCheck ?? && sysSet.isNeedAuthenCheck  && sysSet.isNeedAuthen?? &&  sysSet.isNeedAuthen>
			            	<th width="5%"><@spring.message code="agent.member.check"></@spring.message></th>
			            </#if>
			            
			            <th width="6%"><@spring.message code="agent.cabinet.id"></@spring.message></th>
					...
					<#list page.content as info>
						<tr>
				            ...
				            <td>${info.sysCode!}</td>
							 <td>
						         <a href="${ctx}/customer/detail?uid=${info.uid!}"><@spring.message code="agent.form.detail"></@spring.message></a>
				            </td>
						</tr>
					</#list>
				</table>
