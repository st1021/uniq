    ...
    <div class="page-container-custom">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span><@spring.message code="merchant.member.info"></@spring.message><i class="fa fa-angle-right"></i></span>
                </li>
                <li>
                    <span>
				...
				<@tags.message content=message! />
				 <div class="form-body">
				 	...
				 	<div class="form-group">
						<label class="col-md-3 control-label"><@spring.message code="merchant.member.headImgPath"></@spring.message>:</label>
						<div class="col-md-4">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><@spring.message code="merchant.member.nickname"></@spring.message>:</label>
						<div class="col-md-4">
					...
					<#if is_open_balance?? && is_open_balance>
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.balance"></@spring.message>:</label>
							<div class="col-md-4">
								<p class="form-control-static">
					...
					<#if is_open_vip?? && is_open_vip>
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.vip"></@spring.message>:</label>
							<div class="col-md-4">
								<p class="form-control-static">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><@spring.message code="merchant.member.register"></@spring.message>:</label>
						<div class="col-md-4">
							<p class="form-control-static">
					...
					<#if u_regist?? && u_regist >
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.check"></@spring.message>:</label>
							<div class="col-md-4">
								<p class="form-control-static">
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.check.step"></@spring.message>:</label>
							<div class="col-md-4">
								<p class="form-control-static">
					...
					<#if u_regist?? && !u_regist>
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.number"></@spring.message>:</label>
							<div class="col-md-4">
								<p class="form-control-static">
									${info.idCard!}
								</p>
					...
					<#if setting.isNeedAuthen?? && setting.isNeedAuthen>
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.idcard"></@spring.message>:</label>
							<div class="col-md-4">
					...
					<#if setting.isNeedAuthen?? && setting.isNeedAuthen && setting.authenType?? && setting.authenType == 'student_card'>
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.school"></@spring.message>:</label>
							<div class="col-md-4">
								<p class="form-control-static">${info.schoolName!} </p>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label"><@spring.message code="merchant.member.studentId"></@spring.message>:</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<label class="col-xs-3 control-label"><@spring.message code="merchant.member.studentCard"></@spring.message>:</label>
