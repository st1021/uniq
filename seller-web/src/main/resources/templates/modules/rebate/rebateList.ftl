	...
	<div class="page-container-custom">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
				    <span><@spring.message code="merchant.index.incomeList"></@spring.message></span>
				</li>
            </ul>
        </div>
        ...
        <div class="portlet light portlet-fit portlet-datatable ">
	       <ul class="nav nav-tabs mb-25">
	            <li class="active">
	                <a data-toggle="tab" href="javascript:;"><@spring.message code="merchant.index.incomeList"></@spring.message> </a>
	            </li>
	        </ul>
         ...
         <#if (page.content?size > 0)>
	        <div class="portlet-body">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-checkable order-column dataTable">
					<tr>
						<th><@spring.message code="merchant.member.nickname"></@spring.message></th>
						<th><@spring.message code="merchant.income.revenueType"></@spring.message></th>
			            <th><@spring.message code="merchant.income.revenueTime"></@spring.message></th>
			            <th><@spring.message code="merchant.income.revenueAmount"></@spring.message></th>
					</tr>
