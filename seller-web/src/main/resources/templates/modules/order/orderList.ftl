	        ...
	        <div class="portlet-body">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-checkable order-column dataTable">
					<tr>
			            ...
			            <th width="6%"><@spring.message code="merchant.order.payment.type"></@spring.message></th>
				           	...
				           	<td>
								...
								<#elseif info.payType ?? && info.payType == 'balance'>
									 balance ${info.payPrice!}
										...
										<br/>
										<@spring.message code="merchant.order.coupon"></@spring.message>:${info.ticketAmount!}
										</#if>
